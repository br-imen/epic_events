...
valid_delete_contract_data = {
    "id": 1
}

invalid_delete_contract_data = {
...
def test_validate_create_contract_input_valid(mock_validation_error):
    ...
    assert user_input.commercial_collaborator_id == valid_create_contract_data["commercial_collaborator_id"]
...
def test_validate_update_contract_input_valid(mock_validation_error):
    ...
    assert user_input.commercial_collaborator_id == valid_update_contract_data["commercial_collaborator_id"]
