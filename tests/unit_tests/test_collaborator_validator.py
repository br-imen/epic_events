...
from validators.collaborator_validator import validate_login_input, validate_collaborator_input, validate_delete_collaborator_input
...
valid_delete_collaborator_data = {
    "employee_number": 12345
}
