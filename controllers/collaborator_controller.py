...
from controllers.collaborator_validator import LoginInput, CollaboratorInput, DeleteCollaboratorInput
from models.collaborator import Collaborator
from views.collaborator_view import error_collaborator_non_found_view, success_delete_collaborator_view, success_login_view, success_create_collaborator_view, error_invalid_email_password_view, success_update_collaborator_view, validation_error_view, list_collaborators_view
...
def update_collaborator_controller(employee_number,name,email,role_id,password):
    ...
    if validated_data:
        session = SessionLocal()
        try:
            collaborator = Collaborator.get_by_id(employee_number=employee_number,session=session)
            if collaborator:
